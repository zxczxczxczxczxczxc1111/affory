...
Assets are bundled locally and never fetched when the application runs.
The adjacent `LICENSE.simple-icons.txt` contains the upstream CC0 1.0 dedication.
Brand names and marks belong to their respective owners; their appearance identifies routing destinations.
