...
1. Скачай **Affory-1.1.3-setup.exe** из [релизов](https://github.com/zxczxczxczxczxczxc1111/affory/releases/latest) и установи. Windows запросит права администратора.
...
Правила начинают действовать после подключения. Если хочешь использовать прямые маршруты, оставь настройку **«блокировать сеть при обрыве VPN»** выключенной: она запрещает соединения мимо VPN.
