...
func trojan(s string) (protokol.Server, error) {
	...
	//
	// Username() отдаёт пароль уже раскодированным, и второго раскодирования
	// здесь быть не должно. До 26.09.2026 тут стоял ещё QueryUnescape: он снимал
	// кодирование повторно и по правилам строки запроса, где «+» это пробел, и
	// base64-пароль «kX9+q/Zt4=» становился «kX9 q/Zt4=». Стандарт ссылок Xray,
	// v2rayN и v2rayNG кодируют и раскодируют userinfo ровно один раз.
